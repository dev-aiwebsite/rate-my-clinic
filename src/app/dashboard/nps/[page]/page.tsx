...
export default function Page({params}:{params:any}){
    ...
    return (<>
        ...
        <div className="group h-fit min-h-full col-span-3 row-span-5 max-md:!pb-30 md:card md:p-16">
            ...
            <HelperCard isVisible={appUserConfig.helper_card.display} onClose={handleHelperOnClose} canClose={true} className="card max-h-[14rem] max-w-[24rem] max-md:mt-6 max-md:w-full max-md:ring-0 md:absolute md:bottom-0 md:right-5"/>
        </div>
    </>
