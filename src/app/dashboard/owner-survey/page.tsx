...
export default function Page({searchParams}:{searchParams:any}) {
    ...
    if(isSurveyClosed){
        const SurveyClosed = () => {
            return <div className="w-full card flex-1 text-center text-balance ">
           <h1 className="text-2xl text-orange-400 mb-4">
                Your final report has been generated.
            </h1>
            <span className="block text-lg text-gray-500">The survey forms are now closed.</span>
        </div>
        }
        FormComponent = SurveyClosed

    } else {
        const OwnerSurveyForm = ({additionalClass,afterSubmit}:{additionalClass?:string,afterSubmit?: () =>void}) => { 
            ...
            // Cliniko, Nookal, Pracsuite, Gensolve, Splose
            const practice_management_software_list = [
                {label: 'Cliniko', value: 'cliniko'},
                {label: 'Nookal', value: 'nookal'},
                {label: 'Pracsuite', value: 'pracsuite'},
                {label: 'Gensolve', value: 'gensolve'},
                {label: 'Splose', value: 'splose'},
            ]
            const email_software_list = [
                            ...
                            <div className={`formSectionContainer ${page == 6 ? "" : "!hidden"}`} data-formpage="6">
                                ...
                                <div className="formSectionContent">
                                    ...
                                    <div className="sm:col-span-1">
                                        ...
                                        <div className="mt-2">
                                            <div className="formField">
                                            <SelectWithOther name="practice_management_software" options={practice_management_software_list} onChange={handleChange} value={formData.practice_management_software} />
                            ...
                            <div className={`formSectionContainer ${page == 13 ? "" : "!hidden"}`} data-formpage="13">
                                ...
                                <div className="formSectionContent">
                                    ...
                                    <div className="sm:col-span-1">
                                        ...
                                        <div className="mt-2">
                                            <div className="formField">
                                            <SelectWithOther name="email_software" options={email_software_list} onChange={handleChange} value={formData.email_software} />
