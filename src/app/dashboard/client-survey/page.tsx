    ...
    return (
        <div className="bg-transparent flex-1 p-6 gap-x-6 gap-y-10 grid grid-cols-3 grid-rows-6">
            ...
            <div className="card col-span-3 row-span-5 p-20">
               {ownerSurveyDone && <>
                <p className="text-md text-center text-gray-600">Please send this survey to all clients that you visited your clinic in the last 12 months. We recommend offering a major prize of $200 to one lucky winner. To distribute the survey, we suggest using Mailchimp or similar to email. It may also be worthwhile creating a flyer with the QR code to display in your clinic to encourage more responses.</p>
